...
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "`DC 21 Acrobatics check` to approach without triggering the trap followed by `DC 23 Thievery check` (expert) to erase the rune, or [[Spells/Dispel Magic|Dispel Magic]] (3rd rank; counteract DC 20) to counteract the rune"
attacks:
  - name: ""
