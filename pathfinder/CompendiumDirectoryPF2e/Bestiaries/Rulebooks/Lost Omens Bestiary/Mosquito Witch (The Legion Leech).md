...
abilities_top:
  ...
  - name: "Wild Empathy"
    desc: "  The Mosquito Witch can use Diplomacy to [[Actions/make-an-impression|make-an-impression]] on and make [[Actions/request|request]]{Requests} of arthropods (insects, spiders, and similar invertebrates like bloodseekers). Most arthropods have a starting attitude of indifferent to the Mosquito Witch."
