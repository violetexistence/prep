---
title: "Droven (Level 3)"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.iconics.Actor.W8MWLP3c3lHw9cNq" 
tags:
...
languages: "Fey, Goblin, Orcish, Razatlani, Sakvroth, Common"
skills:
  - name: "Skills"
    desc: ""
abilityMods: [3, 1, 1, 4, 0, 0]
speed: 25 feet
sourcebook: "__"
ac: 19
armorclass:
  - name: AC
    desc: "19; __Fort__ +8, __Ref__ +6, __Will__ +7"
hp: 38
health:
  - name: ""
  - name: HP
...
abilities_top:
  - name: ""
  - name: "Items"
    desc: "[[Equipment/Hide Armor|Hide Armor]], [[Equipment/Backpack|Backpack]], [[Equipment/Prosthesis|Prosthesis]], [[Equipment/Crossbow|Crossbow]], 20x [[Equipment/Bolts|Bolts]], [[Equipment/Warhammer|+1 Warhammer]], [[Equipment/Dagger|Dagger]], [[Equipment/Basic Crafter's Book|Basic Crafter's Book]], [[Equipment/Bedroll|Bedroll]], 10x [[Equipment/Chalk|Chalk]], [[Equipment/Flint and Steel|Flint and Steel]], 2x [[Equipment/Rations|Rations]], [[Equipment/Rope|Rope]], [[Equipment/Soap|Soap]], [[Equipment/Thieves' Toolkit|Thieves' Toolkit (built into Whirp)]], [[Equipment/Repair Toolkit|Repair Toolkit (built into Whirp)]], 5x [[Equipment/Torch|Torch]], [[Equipment/Waterskin|Waterskin]], 2x [[Equipment/Gold Pieces|Gold Pieces]], 2x [[Equipment/Healing Potion (Minor)|Healing Potion (Minor)]], [[Equipment/Ablative Armor Plating (Moderate)|Ablative Armor Plating (Moderate)]], [[Equipment/Blast Boots (Moderate)|Blast Boots (Moderate)]]"
  - name: "[[Actions/Explode|Explode]]"
    desc: "`pf2:2` (fire,inventor,manipulate,unstable) You intentionally take your innovation beyond normal safety limits, making it explode and damage nearby creatures without damaging the innovation... hopefully. The explosion deals 2d6 damage with a `Reflex check` to all creatures in a 5-foot emanation around you (if you're wearing or holding the innovation) or around your innovation (if your innovation is a minion).\n\nAt 3rd level, and every level thereafter, increase your explosion's damage by 1d6.\n\nIf you have the breakthrough innovation class feature, you can choose either a 5-foot or 10-foot emanation for the area when you use Explode; if you have the revolutionary innovation class feature, you can choose a 5-foot, 10-foot, or 15-foot emanation."
